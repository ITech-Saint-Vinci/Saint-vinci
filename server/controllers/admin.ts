...
export const addAStudent = async (req: Request, res: Response): Promise<void> =>{
    try {
        ...
        const classData = await Class.findOneAndUpdate({_id: classId},  { $push: { students: newStudent._id } }, {new: true}).populate("students")
