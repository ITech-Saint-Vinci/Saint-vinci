...
function CloseYear() {
    ...
    <main className="container px-4 py-6 flex flex-col items-center gap-3 w-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <Button variant="default" onClick={onSubmit} disabled={mutationPatchYear.isLoading || !mutationOnLoad.data?.year.year || mutationOnLoad.data?.students.map((classes)=>classes.students).flat().length ===0}
